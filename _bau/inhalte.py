...
def posten(bezeichnung, wert, zusatz=""):
    ...
    w = wert if wert else '<span class="p-leer">auf Anfrage</span>'
...
PREISE = kopfteil(
    "Was der Führerschein in Freiburg kostet.",
    "Die Zahlen unten stehen so auch als Preisaushang nach § 32 Fahrlehrergesetz "
    "in unseren Büros in Zähringen und im Stühlinger. Keine Pakete, keine "
    "versteckten Posten: Du zahlst den Grundbetrag und die Fahrstunden, die du "
...
KLASSEN = kopfteil(
    ...
    "Ob erster Führerschein, Wohnwagen oder Pferdeanhänger: Deine Freiburger "
    "Fahrschule bildet in den Klassen aus, die du im Alltag wirklich brauchst."
) + '''
  <section>
...
FAHRSCHULE = kopfteil(
    ...
    "Keine Massenabfertigung, kein ständiger Wechsel: In dieser Freiburger "
    "Fahrschule fährst du mit jemandem, der weiß, wo du stehst und was du noch "
    "brauchst."
) + '''
  <section>
    <div class="shell about-grid">
      <div class="about-copy reveal">
        <p class="lead">
          ...
          und habe die Fahrschule ARI im Februar 2024 in Freiburg neu eröffnet, mit einer
        ...
        <p>
          ...
          Betreuung merkst du selbst, wann du bereit bist. Wie viele Fahrstunden
          jemand braucht, ist von Mensch zu Mensch verschieden, und das ist
          völlig normal.
        </p>
        <p>
      ...
      <figure class="about-figure reveal reveal-delay-1">
        ...
        <figcaption>Miftar Rexhepi, seit über zehn Jahren Fahrlehrer in Freiburg.</figcaption>
      </figure>
    </div>
  </section>
    ...
    <div class="shell">
      ...
      <div class="why-grid">
        ...
        <div class="why-item reveal reveal-delay-1">
          ...
          <h3>VW Golf 8 R, Automatik</h3>
          <p>Für alle, die auf Automatik lernen und mit B197 trotzdem einen
             Führerschein ohne Beschränkung bekommen wollen.</p>
        </div>
...
SEITEN = {
    "preise.html": dict(
        ...
        beschreibung="Was der Führerschein in Freiburg kostet: Preisaushang der ARI Fahrschule nach § 32 Fahrlehrergesetz mit Grundbetrag, Fahrstunden und Prüfungsgebühren für B, B96 und BE.",
        inhalt=PREISE, aktiv="preise.html"),
    "klassen.html": dict(
        titel="Führerscheinklassen in Freiburg | ARI Fahrschule",
        beschreibung="Führerscheinklassen bei deiner Freiburger Fahrschule im Detail: B für den Pkw, B197 mit Automatik, B96 und BE für Anhänger.",
