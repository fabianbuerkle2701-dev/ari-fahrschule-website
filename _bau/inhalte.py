  ...
  <section>
    <div class="shell about-grid">
      ...
      <figure class="about-figure reveal reveal-delay-1">
        <img src="images/miftar.jpg" alt="Miftar Rexhepi, Inhaber und Fahrlehrer der Fahrschule ARI, an einem der Fahrschulwagen." width="579" height="900" loading="lazy">
        <figcaption>Miftar Rexhepi, Inhaber und Fahrlehrer der Fahrschule ARI.</figcaption>
      </figure>
    </div>
  </section>
